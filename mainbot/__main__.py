...
from defightbot import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from defightbot.modules import ALL_MODULES
from defightbot.modules.helper_funcs.chat_status import is_user_admin
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("defightbot.modules." + module_name)
