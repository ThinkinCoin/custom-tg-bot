...
from custombot import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, BAN_STICKER
from custombot.__main__ import GDPR
from custombot.__main__ import STATS, USER_INFO
from custombot.modules.disable import DisableAbleCommandHandler
from custombot.modules.helper_funcs.extraction import extract_user
...
def gdpr(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("Your personal data has been deleted.\n\nNote that this will not unban "
                                        "you from any chats, as that is telegram data, not custombot data. "
