...
from defightbot import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, BAN_STICKER
from defightbot.__main__ import GDPR
from defightbot.__main__ import STATS, USER_INFO
...
def gdpr(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("Your personal data has been deleted.\n\nNote that this will not unban "
                                        "you from any chats, as that is telegram data, not defightbot data. "
