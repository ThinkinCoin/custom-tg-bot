...
class Config(object):
    ...
    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = 'postgresql://defightbot:Padrao123#@35.223.108.70:5432/defightdb'  # needed for any database modules
    ...
    NO_LOAD = ['rss,users,translation,backups,log_channel']
    WEBHOOK = False
    URL = None
